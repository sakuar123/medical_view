<template>
  <div id="index-body">
    <div id="index-header">
      <el-row>
        <el-col :span="12">
          <div class="grid-content bg-purple"><h1>消息公告</h1></div>
        </el-col>
        <el-col :span="12">
          <div class="grid-content-bg-purple-light">
            <el-button type="primary" @click="remove()" plain>删除</el-button>
            <el-button type="primary" @click="jumpToSave()">新增消息</el-button>
          </div>
        </el-col>
      </el-row>
    </div>
...
<script>
import {search} from "@/api/announcement";
...
export default {
  ...
  methods: {
    ...
    handleClickEdit(rowId) {
      // this.$alert(rowId);
      this.$router.push({path: 'announcement_edit', query: {id: rowId}})
    },
    ...
    jumpToSave() {
      this.$router.push("announcement_save");
    },
    remove() {
