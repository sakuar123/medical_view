    ...
    <div id="box-card">
      <el-form :model="entity" ref="ruleForm" :rules="rules" label-width="100px">
        ...
        <el-form-item label="密码" prop="administratorPassword">
          <el-input type="password" v-model="entity.administratorPassword"></el-input>
        </el-form-item>
...
<script>
import {create} from "@/api/administrators-info";
  ...
  methods: {
    onSubmit(formName) {
      this.$refs[formName].validate((valid) => {
        ...
        this.entity.administratorStatus = this.value ? 0 : 1;
        this.entity.roleId = this.roleId;
        this.$alert(this.roleId);
      });
    },
    jumpTo() {
