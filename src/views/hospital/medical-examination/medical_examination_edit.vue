<template>
  <div id="body_save">
    <div style="margin: 30px 0px"><h3>修改项目信息</h3></div>
    <div>
...
import {get, modify} from "@/api/medical-examination-info";
...
export default {
  ...
  created() {
    this.entity.comboId = this.$route.query.id;
  ...
  methods: {
    ...
    get(id) {
      get(id).then(res => {
        this.$nextTick(() => {
          this.entity.comboId = res.data.comboId
        });
