<template>
  <div id="save_body">
    <h1 style="color: #409EFF">编辑科室信息</h1>
    <div id="save_form">
...
<script>
import {get, getDepartmentInfo, modify} from "@/api/department-info";
  ...
  methods: {
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        ...
        if (this.entity.id === this.entity.parentId) {
          this.$message.error("请选择正确的科室信息");
          return false;
        }
        this.modify();
      });
